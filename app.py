...
# 1. 앱 기본 설정 및 환경 변수
# ==========================================
st.set_page_config(page_title="은퇴 준비하기 v6.5.7", layout="wide")
...
# ==========================================
# 3. 사이드바 내비게이션 (v6.5.7: 3개 메뉴로 간소화)
# ==========================================

with st.sidebar:
    st.title("은퇴 준비하기 v6.5.7")
...
if menu == "💰 자산관리":
    ...
    # ⚠️ [v6.5.7 임시 비활성화] 현금흐름·리밸런싱·월간리포트 탭은 메뉴 간소화를 위해
    ...
    # =====================================================
    # 탭7: 현금흐름 (구 메뉴 그대로)
    # ⚠️ v6.5.7: UI 간소화를 위해 임시 비활성화 (코드는 보존, 삭제 아님)
